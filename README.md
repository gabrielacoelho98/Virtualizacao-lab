...
#### Criação da VM
![Criação Windows](img/criacao-win.png)

#### Configuração Geral
![Configuração Windows](img/config-win.png)

#### Instalação
![Instalação Windows](img/install-win.png)

#### Sistema em Execução
![Windows Running](img/running-win.png)
...
#### Criação da VM
![Criação Linux](img/criacao-linux.png)

#### Configuração Geral
![Configuração Linux](img/config-linux.png)

#### Instalação
![Instalação Linux](img/install-linux.png)

#### Sistema em Execução
![Linux Running](img/running-linux.png)
